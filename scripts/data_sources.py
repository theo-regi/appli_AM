...
import pandas as pd
#-------------------------------------------------------------------------------------------------------
#----------------------------Scripts to implement Data Sources ----------------------------------------
#-------------------------------------------------------------------------------------------------------
#Class DataSource:: Abstract Class to get data from assets
class DataSource(ABC):
    ...
    @abstractmethod
    def fetch_hist_prices(self, isin:str=None, start=None, endtr=None) -> pd.Series:
        """
...
class YahooFinance(DataSource): #Could be continuer with other functionnalities
    ...
    def fetch_hist_prices(self, isin:str, start=None, end=None) -> pd.DataFrame:
        """
        Fetch historical prices of the asset based on the isin, start and end date."
    ...
    def fetch_volumes(self, isin:str, start=None, end=None) -> pd.DataFrame:
        """
    ...
    def fetch_dividends(self, isin:str, start=None, end=None) -> pd.Series:
        """
    ...
    def fetch_splits(self, isin:str, start=None, end=None) -> pd.Series:
        """
